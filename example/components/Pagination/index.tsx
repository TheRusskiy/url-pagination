...
export default function Pagination({
  ...
  const linkClassName =
    'relative inline-flex items-center border border-gray-300 bg-white text-sm font-medium hover:bg-orange-50 py-2 outline-none-mouse'
  return (
    <ReactPaginate
      activeClassName={cn('font-bold')}
      activeLinkClassName="bg-orange-100 font-bold"
